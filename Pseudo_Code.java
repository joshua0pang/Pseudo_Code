...
Excited from her dream last night, Caroline jumps out of bed and runs to her friend Old Mr. Computer. She needs to 
Mr. Computer to remember the events of her dream because sometimes she forgets. Old Mr. Computer is Old Faithful 
...
Caroline loves Old Mr. Computer unconditionally. They have known each other all their lives. She has made getting to
know his lingo — called Java — a creative project. Old Mr. Computer needs Caroline to help him communicate. He has
...
{ 
	...
	// something worth the effort of doing the action of a verb with a noun. A return statement is the similar 
	// to  as using a paragraph or series of paragraphs to make a point, or prove a thesis. The return statement
	// is the proven thesis. There may be many theses that need to be proven in order to prove a hierarchically 
	// larger thesis. This is mildly pyramidal if you think about it, the bricks build higher until the apex.
...
//Author's Endnote
 ...
 community, and learned a lot. I also found the community excessively aggressive, competitive, and threatening. 
 Programming in this environment is unforgiving, adding insult to injury. More work needs to be done on the 
 engineering side to allow for "good enough" programming. People speak algorithmically, not programatically. They 
 slang. However, regular people need to be a bit more organized in order to be responsible with increasingly 
