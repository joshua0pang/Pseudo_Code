...
"Welcome to Pseudo Code. In this novella, we'll be sharing small, relaxing tales which sneak in byte sized bits of computer science here and there. Enjoy!"

// Chapter 1: The Flowers Of The Garden 
// An Introduction to Loops 

The Flowers Of The Garden live life in a cycle. They recycle. 
Every day The Flowers play in sunlight, then dream in moonlight, then play in sunlight, then dream in moonlight. This cycle recycles forever. The Earth loves to recycle. 
Every season The Flowers grow big, then grow small, then grow big, then grow small. This cycle recycles forever. The Earth loves to recycle.
The Flowers of the Garden live life in a cycle. They recycle. 
...
Caroline tends her garden lovingly. She cares for each little flower individually, "Hello little flower, how are you this morning?" She smiles as she waters the thirsty plants. 
Caroline is quite a good gardener. She has ever so many flowers! In fact, Caroline is getting overwhelmed by her success. 
She needs to organize how she cares for her flowers, so she can give each one the care and love they deserve. "Oh little flowers, what will I do?" 
That night, Caroline finds the solution she needs in a dream.

Moral Of The Story: Gardener Caroline needs "data structures" to manage the plethora of flowers in her garden. In computer science, we need data structures to manage the plethora of binary code in our programs.
...
Caroline has greeted each day every day in this way all her life. This is her World Famous Caroline Morning Loop! "I wonder how The Flowers greet the new day?"
Excited from her dream last night, Caroline jumps out of bed and runs to her friend Old Mr. Computer. She needs to Mr. Computer to remember the events of her dream because sometimes she forgets. Old Mr. Computer is Old Faithful when it comes to remembering things for our friend Gardener Caroline.

In her dream, Caroline found herself upset in the middle of her garden. Suddenly, all the flowers gathered around her in a protective circle. 
"Caroline, why are you upset? You give us so much water and food and love, what can we do to lift your spirit?" 
Caroline replied, "Little flowers, I am worried about how I can take care of all of you... How can I love all of you equally?" 
...
Finally, A Green Flower introduced himself, "My name is Mr. Green. Caroline, perhaps you could tell Old Mr. Computer about our names when you wake up?"

While chatting with Old Mr. Computer, Caroline thought of a way to organize all the names of all The Flowers Of The Garden. Ever since she was little, Caroline had tied colored strings around her fingers to keep track of important things she needed to remember. She tied a blue string around her first finger for Mr. Blue, a yellow string around her second finger for Ms. Yellow, and a green string around her third finger for Mr. Green.

Remembering how she used to remember things, Caroline asked Old Mr. Computer to remember the names of The Flowers like this:

Blue String = "Mr. Blue"
Yellow String = "Ms. Yellow"
Green String = "Mr. Green"

Caroline simply cannot remember the last time she was this happy. The Flowers all introduced themselves to her!!! And they said they love everything about how she cares for them. She can hardly contain her glee.

Moral Of The Story: Just as The Flowers declared their names, in computer science we need to have names for things as well. We call these names for things "variables". We call introducing names "declaring." Giving the name a "value" we call "initialization". But lets not get too technical, shall we?

// Chapter 4: Caroline Finds Joy In Old Mr. Computer's Jargon
// Correct String Syntax In Java

Caroline, being a wonderful gardener, is used to interacting with bugs. Bees provide sweet music as they buzz around The Flowers. 

Old Mr. Computer usually has a few bugs crawling around his circuits. Since Caroline was used to bugs in her garden, and they were minor, she let them be. Like bugs in her garden, the bugs crawling around in Old Mr. Computer may be useful in mysterious ways. The bugs caused Mr. Computer to remember her words like this:
...
"Oh Caroline, you did not visit me yesterday. I've have had nothing to drink, and I'm parched with thirst. I'm exhausted, and too dry even to cry."

At that very moment, Caroline resolved herself to never again forget to feed any one of The Flowers. She went home that night to think with her whole entire brain in order to find a solution. Naturally, she found one.

Many years ago, Caroline wore braces to straighten her teeth. Today, Caroline has the most beautiful smile for miles around. 

Caroline was reminded of this when she was thinking about how to straighten out her problem. She realized Old Mr. Computer could organize her thoughts with opening "{" and closing "}" braces like this:
...
Caroline found the braces to be very useful in organizing her ideas. She started to use them anytime she worked with Old Mr. Computer, as it helped to keep both of them organized. Like the fence which protects The Garden, computer braces protect her ideas.

Moral Of The Story: Everyone needs to structure their ideas. There are a limited number of conventions to begin and end a thought. In English, we use capital letters and periods. In Java, we use opening and closing braces. 
...
One morning, Caroline was chatting with Mr. Computer and found out he had confused a few things. Being the kind and patient person she is, and given that his mistakes were harmless, she was happy the way they were. In fact, Old Mr. Computer is endearing to her heart because of his quirky glitches. With an air of humor, Caroline imagines it is her job to fix his faults. She does not take her job seriously, and solely focuses on having fun. This way, everyone wins.

Mr. Computer had kept the braces like Caroline asked. However, shame-faced, Mr. Computer admitted he accidentally added a few things. It looked like this:
...
Gathering her energy, Caroline slowly and gradually asked Old Mr. Computer a few questions about the changes he had made.
"Dear Mr. Computer, can you explain how you changed my schedule from English to Java?"
"Well Caroline, if you think about it, Java and English are not that far apart. There are just a few grammatical differences, but essentially a sentence in English is a sentence in Java. If you can understand this, you'll go far. On Planet Computer, where I am from, we explain ourselves through terse interspersed comments around code, let's try that method."
...
// Syntax for a while loop. Parentheses are like the mouth of the function. They take in the food to allow the function to run. The technical term is "input."
{
	...
	// That seems fairly intuitive. Caroline taught us about braces, semicolons, all the jargon symbols of Java. The rest reads a bit like a book, don't you think? If Today is Monday, Water Mr. Blue. Simple. If you cannot see this, we have a problem. Seek technical support from a teacher.

} // Closes the "while in the garden" loop
} // Closes the "Schedule for my little flowers" function which not only details what to do when, but forces the program to actually do it. Caroline simply has to trust herself that she'll execute the actions she's set out for herself.
} // Closes the class "Caroline waters the flowers."

// Epilogue: Caroline Travels To Planet Computer
// The Need For Immersion

Caroline sighs to herself. "Mr. Computer, I doubt I will ever learn your language. We're just too different. I feel sad that I've myself resigned to this fate."
